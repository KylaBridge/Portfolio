...
const defaultColors = ["#FFD300", "#FFEA00", "#FFF27A"];
...
const Particles = ({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e) => {
      // compute mouse position relative to the particle container
      const rect = container.getBoundingClientRect();
      // fallback to viewport if container dimensions are zero
